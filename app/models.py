...
class Society(Base):
    ...
    events = relationship("Event", back_populates="organizor")
...
class Event(Base):
    ...
    organizing_society = Column(String, ForeignKey(
        'societies.name', ondelete='Cascade'), nullable=False)
    ...
    organizor = relationship("Society", back_populates="events")
